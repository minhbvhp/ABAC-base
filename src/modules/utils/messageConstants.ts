...
export const NAME_MUST_NOT_EMPTY: string = 'Tên không được bỏ trống';
export const PASSWORD_NOT_STRONG: string =
  'Mật khẩu không đủ mạnh: cần tối thiểu 6 ký tự, 1 chữ hoa, 1 chữ thường, 1 số, 1 ký tự đặc biệt';
export const GENDER_MUST_NOT_EMPTY: string = 'Giới tính không được bỏ trống';
export const PHONE_MUST_NOT_EMPTY: string = 'Số điện thoại không được bỏ trống';
export const ADDRESS_MUST_NOT_EMPTY: string = 'Địa chỉ không được bỏ trống';
...
export const COMPANY_MUST_NOT_EMPTY: string = 'Công ty không được bỏ trống';
